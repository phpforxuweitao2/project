...
<head>
    ...
    <link rel="stylesheet" href="/static/admin/lib/amazeui/css/amazeui.min.css">
    <script src="/static/admin/lib/amazeui/js/jquery-3.1.1.js" type="text/javascript"></script>
    <script src="/static/admin/lib/amazeui/js/amazeui.min.js" type="text/javascript"></script>
    <!--[if lt IE 9]>
